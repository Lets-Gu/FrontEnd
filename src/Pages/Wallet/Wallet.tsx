    ...
    <div className="modal-backdrop" onClick={handleBackdropClick}>
      <div className="modal-content">
        ...
        <div className="coupon-image-placeholder">
          ...
          {item.imageUrl ? (
            <img src={item.imageUrl} alt={item.itemName} className="coupon-image" />
          ) : (
            <span>쿠폰 사진</span>
          )}
        </div>
        ...
        <div className="coupon-details">
          ...
          <div className="detail-row">
            ...
            <span className="detail-value">{item.couponNumber || '정보 없음'}</span>
          </div>
        </div>
...
const Wallet: React.FC = () => {
  ...
  const [selectedCoupon, setSelectedCoupon] = useState<WalletItemBase | null>(null);
            ...
            {list.map((it, idx) => {
              ...
              return (
                <li
                  ...
                  onClick={ isUsed ? () => handleShowCouponModal(it, true) : undefined }
                >
